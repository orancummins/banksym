...
class BankRow(Base):
    ...
    supported_customer_types: Mapped[list] = mapped_column(JSON, default=list)
    open_banking_enabled: Mapped[bool] = mapped_column(default=False)
    card_products: Mapped[list] = mapped_column(JSON, default=list)
    current_account_products: Mapped[list] = mapped_column(JSON, default=list)
    savings_account_products: Mapped[list] = mapped_column(JSON, default=list)
    loan_products: Mapped[list] = mapped_column(JSON, default=list)
